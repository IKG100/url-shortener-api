...
import com.urlshortener.config.openapi.annotations.user.RegisterUserOpenApi;
import com.urlshortener.config.openapi.annotations.user.RegisterUserOpenApiRequestBody;
