package io.github.devexhale.urlshortener.security.provider;

import io.github.devexhale.urlshortener.security.service.CustomUserDetailsService;
...
import static io.github.devexhale.urlshortener.util.MessageProvider.PASSWORD_WRONG_MESSAGE;
 ...
 */
public record CustomAuthenticationProvider(CustomUserDetailsService userDetailsService, PasswordEncoder passwordEncoder) implements AuthenticationProvider {
