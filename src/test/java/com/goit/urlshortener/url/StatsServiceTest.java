...
import com.goit.urlshortener.util.MessageProvider;
...
class StatsServiceTest {
    ...
    void getAllUrlsByUser_shouldReturnSuccessResponse_withAllUrls() {
        ...
        when(urlRepository.findAllUrlsByUser(user.getId())).thenReturn(urls);
        ...
        StatsListUrlResponse response = statsService.getAllUrlsByUser();
    ...
    void getAllUrlsByUser_shouldReturnEmptyResponse_whenNoUrlsExist() {
        when(contextProvider.getAuthenticatedUser()).thenReturn(user);
        when(urlRepository.findAllUrlsByUser(user.getId())).thenReturn(Collections.emptyList());
    ...
    void getActiveUrlsByUser_shouldReturnSuccessResponse_withActiveUrlsOnly() {
        ...
        StatsListUrlResponse response = statsService.getActiveUrlsByUser();
